    ...
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
      <h2>Registered <b>Routes</b></h2>
     </div>

     <div class="col-sm-6">
     

       <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">alt_route</i> <span>Register Bus Route</span></a>
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      @foreach($bus_route as $row)
                        <td id="user_id">{{$row->mini_routes_id}}</td>
                        <td id="">{{$row->destination}}</td>
                        <td id="">{{$row->destination_from}}</td>
                        <td id="">{{$row->destination_to}}</td>
                        <td id="">{{$row->fee}}</td>
   ...
   <div class="modal-content">
    ...
    <div class="modal-body">     
       <div class="form-group">
              ...
              <select class= "select-css" name="route_id"> 
         @foreach($bus_main as $row)
       ...
       <div class="form-group">
       <label>From</label>
       <input type="text" name="from_route" class="form-control" >
      </div>
      <div class="form-group">
       <label>To</label>
       <input type="text" name="to_route" class="form-control" >
      </div>     
      <div class="form-group">
       <label>Fare</label>
       <input type="text" name="fare_route" class="form-control" >
      </div> 
     </div>
 ...
 <div id="editEmployeeModal" class="modal fade">
  <div class="modal-dialog">
   <div class="modal-content">
    ...
    <input type="hidden" name="route_id" value="" id="showId">
     <div class="modal-header">      
     ...
     <div class="form-group">
      <label>Destination</label>
         <select class= "select-css" name="main_route_id"> 
         @foreach($bus_main as $row)
                <option value="{{$row->route_id}}">{{$row->destination}}</option>
           @endforeach 
              </select>
       ...
       <div class="form-group">   
       <label>From</label>
       <input type="text" name="from_des" id="show_from"  class="form-control" >
      </div>
       <div class="form-group">
       <label>To</label>
       <input type="text" name="to_des" id="show_to"  class="form-control" >
      </div>
       <div class="form-group">
       <label>Fare</label>
       <input type="text" name="fare_des"id="show_fare"  class="form-control" >
      </div>
    </div>
     <div class="modal-footer">
      <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
  ...
  <div class="modal-dialog">
   <div class="modal-content">
    ...
    <input type="hidden" name="delete-Id" value="" id="deleteId">
     ...
     <div class="modal-body">     
      <p>Are you sure you want to delete these Route?</p>
...
$(document).ready(function(){
      ...
      $('#user-table').on('click','.edit',function(){
        ...
        var from_des = row.find('td:eq(2)').text();
        var to_des = row.find('td:eq(3)').text();
        var fare_des = row.find('td:eq(4)').text();
        // var date_registered = row.find('td:eq(5)').text();
    

        $('#showId').val(id);    
        $('#show_from').val(from_des);
        $('#show_to').val(to_des);
        $('#show_fare').val(fare_des);
